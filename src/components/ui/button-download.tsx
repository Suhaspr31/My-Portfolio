    ...
    return (
        <Button
            ...
            className={cn(
                ...
                downloadStatus === "downloading" && "bg-foreground/50 hover:bg-foreground/50",
        ...
        >
            ...
            {downloadStatus === "complete" && <span className="text-foreground">Resume</span>}
            {downloadStatus === "downloading" && (
                <div
                    className="absolute bottom-0 z-[3] h-full left-0 bg-foreground inset-0 transition-all duration-200 ease-in-out"
